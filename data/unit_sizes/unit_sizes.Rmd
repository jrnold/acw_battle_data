...
The best source for this is Eicher (p. 65, 74) and Haitman.
...
The size of a regiment is drawn from a uniform distribution
...
To calculate the size of a brigade: draw the number of regiments from a binomial distribution, and for each regiment draw the size.
...
To calculate the size of a division: draw the number of brigades in the division from a binomial distribution, and for each brigade draw the size.
...
To calculate the size of a corps: draw the number of divisions in the corps from a binomial distribution, and for each division draw its size.
...
To calculate the size of an army: draw the number of corps in the army from a binomial distribution, and for each corps draw its size.
